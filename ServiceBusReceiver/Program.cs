...
namespace ServiceBusReceiver
{
    class Program
    {
        ...
        const string ServiceBusConnectionString = "Endpoint=sb://jvsbdemo.servicebus.windows.net/;SharedAccessKeyName=ReceiverKey;SharedAccessKey=QONu+ytJr+5xF1WbH6VcjVl4pr3khqQOkvMT+thtajo=";
